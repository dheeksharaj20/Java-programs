...
public class ConstructorOverloading {
	      ...
	      ConstructorOverloading(long number){
	          ...
	          public static void main(String[] args) {
	        	  ConstructorOverloading identity=new ConstructorOverloading("Dheeksha",'R');
	        	  ConstructorOverloading identity1=new ConstructorOverloading("Rakshitha",'N',98235654);
	        	  ...
	        	  ConstructorOverloading identity2=new ConstructorOverloading(9886347l);
	        	   System.out.println("for 10 digit no."+identity2.num);


	        	   ConstructorOverloading identity3=new ConstructorOverloading(98235654);
